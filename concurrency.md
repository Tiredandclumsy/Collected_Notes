Concurrency refers to processing that is logically simultaneous. It need not be physically simultaneous (physically separated into different threads on a processor). 
